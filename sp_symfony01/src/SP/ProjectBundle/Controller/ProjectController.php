...
use SP\ProjectBundle\Entity\Project;
...
class ProjectController extends Controller
{
    ...
    {
        $project = new Project();
        $form = $this->createForm('SP\ProjectBundle\Form\ProjectType', $project);
    ...
    {
        $deleteForm = $this->createDeleteForm($project);
        $editForm = $this->createForm('SP\ProjectBundle\Form\ProjectType', $project);
